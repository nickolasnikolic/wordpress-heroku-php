...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'vidiho');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Vidiho'); 
...
if(!defined('CI_FORUM'))			define('CI_FORUM', 'http://cssigniter.com/support/viewforum.php?f=29');
